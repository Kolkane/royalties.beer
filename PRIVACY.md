...
A collector bug that leaks a non-whitelisted field is a critical severity issue: public disclosure in the repo, affected data deleted at ingest, post-mortem published. Report privately via [GitHub Security Advisories](https://github.com/Kolkane/royalties.beer/security).
